...
ADD "https://github.com/just-containers/s6-overlay/releases/download/v1.17.1.1/s6-overlay-amd64.tar.gz" "/tmp/s6.tar.gz" 
...
RUN cd /opt  && ./dotnet-install.sh --version 5.0.408
COPY rootfs/ /
